...
export default function LRBCLanding() {
  ...
  Creating systems that scale
            ...
            <h1 className="animate-fade-in-up text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-8 md:mb-12 leading-[1] md:leading-[0.95] tracking-tighter" style={{animationDelay: '100ms'}}>
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-petrol-600 via-cyan-high to-teal-400">Indian Manufacturing</span>
            </h1>
            ...
            <p className="animate-fade-in-up text-lg md:text-xl lg:text-2xl text-white/50 mb-12 md:mb-16 max-w-3xl font-medium leading-relaxed tracking-tight" style={{animationDelay: '300ms'}}>
              Turn operational chaos into a growth engine. We don't just fix problems; we build the foundational operating systems by designing custom workflows and automation tailored to your unique needs. Empowering organisations to turn daily "firefighting" into strategic success.
            </p>

            <div className="animate-fade-in-up flex flex-col sm:flex-row items-center gap-10 mb-20" style={{animationDelay: '500ms'}}>
              <a href="#contact" className="w-full sm:w-auto bg-petrol-600 text-white px-10 py-5 rounded-2xl text-2xl font-black hover:bg-petrol-700 transition-all shadow-[0_30px_60px_-15px_rgba(13,74,92,0.4)] hover:scale-105 active:scale-95 group flex items-center gap-3">
              ...
              <a href="#workpilot" className="w-full sm:w-auto text-white/70 border-b-2 border-white/20 px-4 py-4 text-2xl font-black hover:text-petrol-600 hover:border-cyan-high transition-all hover:translate-x-2">Work Pilot: End Manual Work</a>
            </div>
            ...
            <div className="animate-fade-in-up flex flex-wrap items-center gap-6 md:gap-10 opacity-80" style={{animationDelay: '700ms'}}>
               ...
               <div className="flex flex-col items-start border-l-2 border-white/20 pl-4 md:pl-6 hover:translate-x-2 transition-transform duration-300">
                  <span className="text-white text-[20px] md:text-[22px] font-black uppercase tracking-[0.3em] mb-1 text-cyan-high">MSME Certified</span>
                  <span className="text-white/80 text-[18px] md:text-[20px] font-bold font-mono">UDYAM-TS-02-0312494</span>
               </div>
               <div className="flex flex-col items-start border-l-2 border-white/20 pl-4 md:pl-6 hover:translate-x-2 transition-transform duration-300">
                  <span className="text-white text-[20px] md:text-[22px] font-black uppercase tracking-[0.3em] mb-1 text-cyan-high">Operation Hub</span>
      ...
      <section className="py-10 bg-slate-950 border-y border-white/5 overflow-hidden">
        <div className="container mx-auto px-6 text-center">
          <p className="text-white/60 text-xl font-mono font-extrabold
              uppercase tracking-[0.5em] mb-6 reveal-on-scroll">
  Trusted by Industry Leaders
</p>

           {/* <p className="text-white/60 text-md font-black uppercase tracking-[0.3em] mb-12 reveal-on-scroll">Trusted by Industry Leaders </p> */}
        </div>
        {/* Marquee Container */}
        <div className="relative overflow-hidden">
            <div className="flex items-center gap-16 animate-marquee">
              {/* First set of logos */}
              <img src={arvLogo} alt="ARV" className="h-12 sm:h-16 md:h-20 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 flex-shrink-0" />
              <img src={aveniorLogo} alt="Avenior" className="h-12 sm:h-16 md:h-20 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 flex-shrink-0" />
              <img src={colorplasLogo} alt="Colorplas" className="h-12 sm:h-16 md:h-20 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 flex-shrink-0" />
              <img src={chefmateLogo} alt="Chefmate" className="h-12 sm:h-16 md:h-20 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 flex-shrink-0" />
              <img src={navtechLogo} alt="Navtech" className="h-12 sm:h-16 md:h-20 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 flex-shrink-0" />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="reveal-on-scroll text-center mb-20">
              <div className="text-petrol-600 font-black uppercase tracking-[0.4em] text-lg sm:text-2xl mb-6">The Core Philosophy</div>
<h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-slate-950 mb-8 leading-[0.9] tracking-tighter">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-petrol-600 to-cyan-high">
  ...
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-petrol-600 to-cyan-high">
    Start Building Systems.
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              {[
                ...
                { 
                  ...
                  desc: "Most owners view operations as a cost centre. Our tailored systems turn your floor into a Profit Center by eliminating leaks, bottlenecks, and human errors." 
                },
                { 
                  icon: "⏱️", 
                  title: "Reclaim Your Time", 
                  desc: "Daily operations shouldn't own you. We first automate the repetitive tasks so you can focus on the strategic ones." 
                }
              ].map((item, i) => (
      ...
      {/* Expertise Section */}
      <section id="expertise" className="py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6 mb-24 relative z-10">
          <div className="reveal-on-scroll flex flex-col md:flex-row justify-between items-end gap-12">
            <div className="max-w-3xl">
              <div className="text-petrol-600 font-black uppercase tracking-[0.4em] text-lg sm:text-2xl mb-6">Sector Mastery</div>
              <h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-slate-950 mb-6 md:mb-8 leading-[0.9] md:leading-[0.85] tracking-tighter">Tailored for <br className="hidden sm:block" /> Indian Industry</h2>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
            <div className="reveal-on-scroll max-w-3xl">
              <div className="text-petrol-600 font-black uppercase tracking-[0.4em] text-3xl mb-6">Strategic Intelligence</div>
              <h2 className="text-5xl md:text-6xl font-black text-white tracking-tighter leading-[0.85]">Consultancy <br /> Modules</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "Financial Core", label: "Tally To Sheet Integration", desc: "Rigorous Tally synchronization with real-time statutory financial reporting." }
            ].map((s, i) => (
              <div key={i} className="reveal-on-scroll group p-12 bg-white/5 rounded-[3rem] border border-white/10 hover:border-cyan-high/50 transition-all duration-500 hover:-translate-y-4">
                <div className="text-petrol-600 font-black uppercase tracking-[0.3em] text-[19px] mb-8 border-b border-white/10 pb-4 inline-block">{s.label}</div>
      ...
      <section id="workpilot" className="py-20 bg-slate-950 overflow-hidden relative">
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20 items-stretch">
            <div className="lg:w-2/5 reveal-on-scroll flex flex-col justify-center">
              <div className="inline-flex items-center gap-3 bg-petrol-600/10 px-6 py-3 rounded-full mb-10 border border-petrol-600/30 w-fit">
                 ...
                 <span className="text-petrol-600 text-2xl font-black tracking-[0.3em] uppercase">Work Pilot: The base for your business</span>
              </div>
              <h2 className="text-6xl md:text-7xl font-black mb-12 text-white tracking-tighter leading-[0.85]">Operating System <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-petrol-600 to-cyan-high">for Accountability.</span></h2>
              
              <div className="space-y-4">
                {[
                  { title: "Smart Delegation & Point-Based Rewards", img: automationImg, desc: "Automatically route tasks based on priority and skill level. Every completion earns Efficiency Points, turning manual work into a measurable performance game for your team." },
                  ...
                  { title: "5-Minute Weekly Review (WRM)", img: moldingImg, desc: "Eliminate long, unproductive meetings. The WRM Dashboard generates your agenda automatically based on team performance data, making every review meeting strategic and swift." },
            ...
            <div className="lg:w-3/5 reveal-on-scroll relative">
               <div className="lg:sticky lg:top-40 bg-white/5 rounded-[2.5rem] sm:rounded-[4rem] border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden backdrop-blur-2xl">
                  ...
                  <div className="p-10 bg-petrol-600 flex justify-center items-center gap-6 group cursor-pointer">
  <span className="text-white text-4xl font-black italic tracking-tighter text-center">
    Request Product Demo
  </span>
  <svg
    className="w-10 h-10 text-white transition-transform group-hover:translate-x-4"
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              <div className="lg:w-1/2 reveal-on-scroll">
                <div className="text-petrol-600 font-black uppercase tracking-[0.4em] text-lg sm:text-2xl mb-6">Data-Driven Strategy: The Owner’s Dashboard</div>
                ...
                <div className="flex flex-wrap gap-4">
                  {["Live Production Data", "Margin Analysis", "Bottleneck Detection", "Throughput Metrics", "Efficiency Optimization"].map((item, i) => (
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="reveal-on-scroll text-center mb-16">
              <div className="text-petrol-600 font-bold uppercase tracking-[0.4em] text-xl sm:text-4xl mb-6">Founder-to-Founder</div>
              <h2 className="text-3xl sm:text-3xl md:text-6xl font-black text-white mb-8 leading-[0.65] tracking-tighter">
              ...
              <p className="text-white/50 font-medium text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
                At Lalit Raj Business Consulting (LRBC), we don't just provide any software; we provide a partnership grounded in academic excellence and official recognition for mutual growth. We combine the strategic depth of an MBA with the technical precision of an Engineer to build systems that are as resilient as the industries we serve.
              </p>
            </div>
            ...
            <div className="reveal-on-scroll bg-white/5 rounded-[2.5rem] p-8 lg:p-12 border border-white/10 mb-12">
              <p className="text-white/80 text-xl md:text-2xl font-medium italic text-center leading-relaxed">
                "Systems are my passion because they are the difference between a business that survives and one that dominates. Having lived the journey of scaling in India, I don't just study systems—I live them. I’m here to help you turn your operational struggle into a strategic edge." — by Lalit Raj
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { 
                  era: "The MBA Years", 
                  title: "Sneko", 
                  desc: "A food-delivery startup built during my MBA, which honed my understanding of logistics, supply chain flow, the critical need for 'Order-to-Delivery' automation, and the importance of excellent service.",
                  badge: "Food-Tech"
                },
                { 
                  era: "The LRBC Evolution", 
                  title: "LRBC", 
                  desc: "Today, I combine these years of startup grit with my experience at IndiaMart, Kellogg's India, and Kotak Mahindra Bank to empower the Indian MSME sector.",
                  badge: "Present"
                }
              ].map((item, i) => (
                <div key={i} className="reveal-on-scroll group p-8 bg-white/5 rounded-[2rem] border border-white/10 hover:border-petrol-600/50 transition-all duration-500" style={{transitionDelay: `${i * 100}ms`}}>
                  <span className="inline-block px-3 py-1 bg-petrol-600/20 text-petrol-600 rounded-full text-lg font-black uppercase tracking-widest mb-3">{item.badge}</span>
                  <div className="text-white/40 font-bold text-md uppercase tracking-widest mb-2">{item.era}</div>
...
<p className="text-white/60 font-bold text-2xl">
  <span className="text-petrol-600">Headquarters:</span> Based in the heart of 
  <span className="text-cyan-400 font-extrabold"> Hyderabad, Telangana</span>, having successfully crossed the 
  <span className="text-cyan-400 font-extrabold"> double-digit milestone</span> in serving industries across India.
</p>
...
>
  <div className="container mx-auto px-6 relative z-10">
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row rounded-[5rem] overflow-hidden shadow-[0_50px_150px_-30px_rgba(0,0,0,0.8)] border border-white/5 bg-petrol-900/50 backdrop-blur-3xl">
      ...
      {/* ✅ Info Side */}
      <div className="lg:w-1/3 px-10 py-16 md:px-16 md:py-24 text-white flex items-center">
        <div className="w-full">

          <div className="text-petrol-600 font-black uppercase tracking-[0.4em] text-lg sm:text-2xl mb-8">
            Consultancy Portal
          </div>

          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mb-10 leading-[0.9] tracking-tighter">
            Initiate <br className="hidden sm:block" /> Your Audit.
          </h2>

          <p className="text-white/40 text-lg sm:text-xl md:text-2xl mb-16 font-medium leading-relaxed">
            Genuine industrial transformation starts with a rigorous diagnostic session.
          </p>
          ...
          <div className="space-y-14">
            ...
            <div className="flex items-start gap-8">
              ...
              <div>
                <h4 className="font-black text-white uppercase tracking-[0.3em] text-[18px] mb-3">
      ...
      {/* ✅ Form Side */}
      <div className="lg:w-2/3 bg-white px-10 py-16 md:px-16 md:py-24 flex items-center">
        {formState.status === "success" ? (
          <div className="w-full flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-5xl font-black mb-6 tracking-tighter text-slate-950 uppercase">
              Audit Requested
            </h3>

            <p className="text-slate-500 font-bold text-lg mb-12">
              The LRBC diagnostics team will contact you <br />
              within 2 business hours for verification.
            </p>
            ...
            <button
              ...
              className="bg-slate-100 text-slate-950 px-10 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-200 transition"
            >
              Submit New Request
            </button>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-4">
                <label className="text-[18px] font-extrabold uppercase tracking-[0.4em] text-slate-800">
                  Executive Name
                </label>
                <input
                  required
                  ...
                  className="w-full bg-slate-50 border-b-2 border-slate-200 px-0 py-5 outline-none focus:border-petrol-600 font-bold text-xl placeholder:text-slate-500"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <select
                ...
                className="w-full bg-slate-50 border-b-2 border-slate-200 px-0 py-5 outline-none focus:border-petrol-600 font-bold text-xl appearance-none"
              >
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border-b-2 border-slate-200 px-0 py-5 outline-none focus:border-petrol-600 font-bold text-xl resize-none placeholder:text-slate-500"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-slate-950 text-white rounded-[2rem] py-7 text-2xl font-black hover:bg-petrol-600 transition-all flex items-center justify-center gap-6 group"
            >
  ...
  {/* Map */}
  <div className="h-[500px] rounded-[4rem] overflow-hidden border border-slate-100 shadow-xl">
        <iframe 
  ...
  {/* CTA */}
          <div className="mb-6 text-center">
            <a href="#contact" className="inline-flex items-center gap-4 bg-petrol-600 text-white px-12 py-6 rounded-xl text-3xl font-black hover:bg-petrol-700 transition-all shadow-[0_20px_40px_-10px_rgba(13,74,92,0.5)] hover:shadow-[0_30px_60px_-15px_rgba(13,74,92,0.6)] group ring-1 ring-white/10">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-white/95 backdrop-blur-sm px-3 py-2 rounded-lg shadow-sm">
                 <img src={lrbcLogo} alt="LRBC Logo" className="h-6 xs:h-12 w-auto object-contain" />
                  {/* <img src="/lrbc-icon.jpeg" alt="LRBC Logo" className="h-8 w-auto object-contain" /> */}
                </div>
                <span className="text-3xl font-black text-white tracking-tighter">LRBC</span>
              </div>
              <p className="text-white/50 text-base font-medium leading-relaxed max-w-md mb-8">
                ...
                The Future of Indian Manufacturing: Systems that Scale.
              </p>
              <div className="space-y-4">
                <div className="flex flex-col">
                  <span className="text-petrol-600 font-black text-xs uppercase tracking-[0.3em] mb-1">Headquarters</span>
                  <span className="text-white/80 font-medium text-sm">Jyothi Enclave, Raj Bhawan Road, Somajiguda, Hyderabad - 500082</span>
                </div>
